...
export function SpaceCard({
  ...
  return (
    ...
    >
        ...
        <div className="order-1 md:order-2 w-full shrink-0 self-start aspect-[3/2] overflow-hidden rounded-t-2xl md:rounded-t-none md:rounded-l-none md:rounded-tr-2xl">
          <ImageCarousel
            images={images}
            alts={localizedAlts}
            alt={localizedName}

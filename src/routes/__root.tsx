  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Hitta och boka studieplatser på KTH Biblioteket." },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/82dfa793-2d3b-4ad3-8059-47e9136ac835/id-preview-3174cfc2--bd232791-3127-4a42-9cbf-7f94edef314e.lovable.app-1780037611269.png",
      },
      {
        name: "twitter:image",
        content:
